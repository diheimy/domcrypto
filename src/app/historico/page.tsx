    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted">Registro de operações e pipeline snapshots</p>
        </div>
        ...
        <div className="flex items-center gap-2">
          <select
            ...
            className="bg-surface border border-border rounded-lg px-4 py-2 text-white text-sm focus:outline-none focus:border-gold"
          >
      ...
      <div className="glass rounded-xl border border-border overflow-hidden">
        <div className="p-4 border-b border-border flex items-center justify-between">
          ...
          <span className="text-sm text-muted">{total} operações</span>
        </div>
